...
module.exports = async (parent, args, { models: { CollectionModel, MediaModel }, helpers: { ValidationHelper, SEOHelper, MediaHelper: { attachMedia } }, error_res, trans, AuthUser }) => {
    ...
    input.source = CollectionModel.sources.campaign;
    ...
    const rules = {
        ...
        condition: {
            model_name: 'string',
            limit: 'integer',
            logic: [`required_if:type,${CollectionModel.types.dynamic}`, { in: Object.values(CollectionModel.logics) }], // todo: bug required_if not working
            'orders.*': {
