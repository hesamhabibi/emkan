  ...
  tableActions: (actions) => [
    {
      ...
      icon: "fa-eye",
      perm: "crm_push_notification_view_record_action",
      tooltip: "view",
      dir: "right",
    },
    {
      ...
      icon: "fa-redo fa-sm",
      perm: "crm_push_notification_redo_action",
      tooltip: "repeat",
      dir: "right",
    },
  ],
  tableFields: (translation) => [
    { title: "title", perm: "crm_push_notification_title_column" },
    {
      title: "status",
      td: (item) =>
        item.status === 1 ? (
      ...
      perm: "crm_push_notification_status_column",
    },
    {
      title: "date",
      td: (row) => new Date(parseInt(row.date, 10)).toLocaleString("fa-IR"),
      perm: "crm_push_notification_date_column",
    },
  ],
    ...
    [
      {
        ...
        perm: "crm_push_notification_title_field",
      },
      {
        size: 6,
        name: "date",
        ...
        perm: "crm_push_notification_message_field",
      },
      {
        ...
        size: 12,
        direction: "ltr",
        perm: "crm_push_notification_link_field",
      },
      {
        rules: { required: true },
        name: "message",
      ...
      {
        perm: "crm_push_notification_send_to_field",
        size: 12,
        render: ({ control }) => (
          <Component
            fields={fields}
