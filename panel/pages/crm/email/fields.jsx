  ...
  const deleteItem = (item) => {
    ...
    setValue(
      ...
      getValues("send_to")?.filter(
        (field) => field.receiver_value !== item.email
      )
    )
  }
          ...
          <Table
            fields={[
              ...
              },
              {
                title: "date",
                td: (row) =>
                  new Date(parseInt(row.date, 10)).toLocaleString("fa-IR"),
              },
            ]}
            actions={[
              {
  ...
  tableActions: (actions) => [
    {
      ...
      icon: "fa-eye",
      perm: "crm_email_view_record_action",
      tooltip: "view",
      dir: "right",
    },
    {
      ...
      icon: "fa-redo fa-sm",
      perm: "crm_email_redo_action",
      tooltip: "repeat",
      dir: "right",
    },
  ],
  tableFields: (translation) => [
    { title: "title", perm: "crm_email_title_column" },
    {
      title: "status",
      td: (item) =>
        item.status === 1 ? (
      ...
      perm: "crm_email_status_column",
    },
    {
      perm: "crm_email_date_column",
      title: "date",
