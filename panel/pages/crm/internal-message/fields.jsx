  ...
  tableActions: (actions) => [
    {
      ...
      icon: "fa-eye",
      perm: "crm_internal_message_view_record_action",
      tooltip: "view",
      dir: "right",
    },
    {
      ...
      icon: "fa-redo fa-sm",
      perm: "crm_internal_message_redo_action",
      tooltip: "repeat",
      dir: "right",
    },
  ],
  tableFields: (translation) => [
    { title: "title", perm: "crm_internal_message_title_column" },
    {
      title: "status",
      td: (item) =>
        item.status === 1 ? (
      ...
      perm: "crm_internal_message_status_column",
    },
    {
      title: "date",
      td: (row) => new Date(parseInt(row.date, 10)).toLocaleString("fa-IR"),
      perm: "crm_internal_message_date_column",
    },
  ],
    ...
    [
      {
        ...
        perm: "crm_internal_message_title_field",
      },
      {
        size: 6,
        name: "date",
        ...
        perm: "crm_internal_message_date_field",
      },
      {
        rules: { required: true },
        name: "message",
        ...
        perm: "crm_internal_message_message_field",
      },
      {
        perm: "crm_internal_message_send_to_field",
        size: 12,
        render: ({ control }) => (
          <Component
            fields={fields}
