      ...
      form: [
        {
          ...
          name: "title",
          type: "multi-language",
          perm: "blogs_project_title_field",
        },
        {
          perm: "blogs_project_has_rate_field",
          size: 6,
          type: "toggle",
          name: "has_rating",
          data: [
        ...
        {
          perm: "blogs_project_has_comment_field",
          size: 6,
          type: "toggle",
          name: "has_comment",
          data: [
        ...
        {
          perm: "blogs_project_status_field",
          size: 6,
          name: "status",
          type: "toggle",
          data: [
        ...
        {
          perm: "blogs_project_publish_at_field",
          name: "publishAt",
          type: "date-time-icon",
          size: 6,
        },
        {
          perm: "blogs_project_category_id_field",
          name: "category_id",
          data: categories,
        ...
        {
          perm: "blogs_project_tag_ids_field",
          name: "tag_ids",
        ...
        {
          perm: "blogs_project_tag_group_id_field",
          name: "tag_group_id",
        ...
        {
          perm: "blogs_project_media_gallery_field",
          size: 12,
          name: "media_gallery",
          type: "image-gallery",
        ...
        {
          perm: "blogs_project_description_field",
          gridSize: 12,
          name: "description",
          type: "multi-language",
    ...
    [
      {
        ...
        input_name: "value",
        select_name: "fields",
        perm: "blogs_project_title_column",
      },
    ],
  ],
  tableFields: (translation) => [
    { title: "title_panel", perm: "blogs_project_title_column" },
    {
      title: "status",
      perm: "blogs_project_status_column",
      td: (item) => (
        <Tag
          type={
            item.status === 3
    ...
    {
      title: "view_count",
      perm: "blogs_project_view_count_column",
  ...
  tableActions: (actions) => [
    {
      ...
      icon: "fa-comments",
      perm: "blogs_project_comments_column",
    },
    {
      onClick: (rows) => actions.edit(rows),
      icon: "fa-edit",
      perm: "blogs_project_edit_action",
    },
    {
      onClick: (rows) => actions.delete(rows),
      icon: "fa-trash-alt",
      perm: "blogs_project_delete_action",
    },
  ],
}
