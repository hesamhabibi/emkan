...
export default function Blogs() {
  ...
  const createModal = () => {
    ...
    setTitle(translation("Add Project"))
  ...
  const editModal = (item) => {
    ...
    setTitle(translation("Edit Project"))
  ...
  return (
    <AdminLayout
      action={
        <Shield id="blogs_project_create_action" action>
          <Button onClick={createModal} type="success">
            <i className="fas fa-plus-circle ml-1" />
            {translation("Add Project")}
          </Button>
        </Shield>
      }
    ...
    >
      ...
      <Shield id="blogs_project_create_action" action>
        <AddBtn title={translation("Add Project")} callback={createModal} />
      </Shield>
