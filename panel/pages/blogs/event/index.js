...
export default function Blogs() {
  ...
  const createModal = () => {
    ...
    setTitle(translation("Add Event"))
  ...
  const editModal = (item) => {
    ...
    setTitle(translation("Edit Event"))
  ...
  return (
    <AdminLayout
      action={
        <Shield id="blogs_event_create_action" action>
    ...
    >
      ...
      />
      <Shield id="blogs_event_create_action" action>
        <AddBtn title={translation("Add Event")} callback={createModal} />
      </Shield>
      <Comment
      ...
      <ModalForms
        ...
        loading={loading}
      />
      <Create type={6} {...modalData} data={extra} setData={setExtra} />
      <Popup
        status="danger"
        id="delete-action"
