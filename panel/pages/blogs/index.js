...
export default function Blogs() {
  ...
  const createModal = () => {
    ...
    setTitle(translation("create", "blog"))
  ...
  const editModal = (item) => {
    ...
    setTitle(translation("edit", "blog"))
  ...
  return (
    <AdminLayout
      action={
        <Shield id="blogs_create_action" action>
          <Button onClick={createModal} type="success">
            <i className="fas fa-plus-circle ml-1" />
            {translation("Add Blog")}
          </Button>
        </Shield>
      }
    ...
    >
      ...
      />
      <Shield id="blogs_create_action" action>
        <AddBtn title={translation("Add Blog")} callback={createModal} />
      </Shield>
      <Comment
