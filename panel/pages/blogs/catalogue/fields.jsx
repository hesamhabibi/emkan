      ...
      form: [
        {
          ...
          name: "title",
          type: "multi-language",
          perm: "blogs_catalogue_title_field",
        },
        {
          gridSize: 12,
          name: "summary",
          type: "multi-language",
          component: "textarea",
          perm: "blogs_catalogue_summary_field",
        },
        {
          size: 6,
          name: "document",
          type: "file",
          perm: "blogs_catalogue_file_field",
        },
        {
          size: 6,
          name: "status",
          ...
          perm: "blogs_catalogue_status_field",
        },
        {
          perm: "blogs_catalogue_has_rate_field",
          size: 6,
          type: "toggle",
          name: "has_rating",
          data: [
        ...
        {
          perm: "blogs_catalogue_has_comment_field",
          size: 6,
          type: "toggle",
          name: "has_comment",
          data: [
        ...
        {
          perm: "blogs_catalogue_publish_at_field",
          name: "publishAt",
          type: "date-time-icon",
          size: 6,
        },
        {
          ...
          size: 9,
          perm: "blogs_catalogue_category_id_field",
        },
        {
          perm: "blogs_catalogue_category_id_field",
          render: () => (
        ...
        },
        {
          ...
          size: 9,
          perm: "blogs_catalogue_tag_ids_field",
        },
        {
          perm: "blogs_catalogue_tag_ids_field",
          render: () => (
        ...
        },
        {
          ...
          type: "select-searchable",
          size: 9,
          perm: "blogs_catalogue_tag_group_id_field",
        },
        {
          render: () => (
            <Grid className="align-self-end" size={3}>
        ...
        },
        {
          ...
          perm: "blogs_catalogue_media_gallery_field",
        },
        {
          gridSize: 12,
          name: "description",
          ...
          perm: "blogs_catalogue_description_field",
        },
      ],
    },
    {
      perm: "blogs_catalogue_seo_tab",
    ...
    [
      {
        ...
        input_name: "value",
        select_name: "fields",
        perm: "blogs_catalogue_title_column",
      },
    ],
  ],
  tableFields: (translation) => [
    { title: "title_panel", perm: "blogs_catalogue_title_column" },
    {
      title: "status",
      perm: "blogs_catalogue_status_column",
      td: (item) => (
        <Tag
          type={
            item.status === 3
    ...
    },
    {
      ...
      perm: "blogs_catalogue_view_count_column",
    },
  ],
  tableActions: (actions) => [
    {
      ...
      icon: "fa-comments",
      perm: "blogs_catalogue_comments_action",
    },
    {
      onClick: (rows) => actions.edit(rows),
      icon: "fa-edit",
      perm: "blogs_catalogue_edit_action",
    },
    {
      onClick: (rows) => actions.delete(rows),
      icon: "fa-trash-alt",
      perm: "blogs_catalogue_delete_action",
    },
  ],
}
