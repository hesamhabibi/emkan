...
export default function Blogs() {
  ...
  const createModal = () => {
    ...
    setTitle(translation("Add Catalogue"))
  ...
  const editModal = (item) => {
    ...
    setTitle(translation("Edit Catalogue"))
  ...
  return (
    <AdminLayout
      action={
        <Shield id="blogs_catalogue_create_action" action>
          <Button onClick={createModal} type="success">
            <i className="fas fa-plus-circle ml-1" />
            {translation("Add Catalogue")}
          </Button>
        </Shield>
      }
    ...
    >
      ...
      />
      <Shield id="blogs_catalogue_create_action" action>
        <AddBtn title={translation("Add Catalogue")} callback={createModal} />
      </Shield>
      <Comment
