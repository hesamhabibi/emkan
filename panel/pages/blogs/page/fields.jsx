      ...
      form: [
        {
          ...
          name: "title",
          type: "multi-language",
          perm: "blogs_page_title_field",
        },
        {
          perm: "blogs_page_has_comment_field",
          size: 6,
          type: "toggle",
          name: "has_comment",
          data: [
        ...
        {
          perm: "blogs_page_has_rate_field",
          size: 6,
          type: "toggle",
          name: "has_rating",
          data: [
        ...
        {
          perm: "blogs_page_publish_at_field",
          name: "publishAt",
          type: "date-time-icon",
          size: 6,
        },
        {
          perm: "blogs_page_category_id_field",
          name: "category_id",
          data: categories,
        ...
        {
          perm: "blogs_page_tag_group_id_field",
          name: "tag_group_id",
        ...
        {
          perm: "blogs_page_media_gallery_field",
          size: 12,
          name: "media_gallery",
          type: "image-gallery",
        ...
        {
          perm: "blogs_page_description_field",
          gridSize: 12,
          name: "description",
          type: "multi-language",
    ...
    [
      {
        ...
        input_name: "value",
        select_name: "fields",
        perm: "blogs_page_title_column",
      },
    ],
  ],
  tableFields: (translation) => [
    { title: "title_panel", perm: "blogs_page_title_column" },
    {
      title: "status",
      perm: "blogs_page_status_column",
      td: (item) => (
        <Tag
          type={
            item.status === 3
    ...
    {
      title: "visit_count",
      perm: "blogs_page_view_count_column",
  ...
  tableActions: (actions) => [
    {
      ...
      icon: "fa-comments",
      perm: "blogs_page_comments_action",
    },
    {
      onClick: (rows) => actions.edit(rows),
      icon: "fa-edit",
      perm: "blogs_page_edit_action",
    },
    {
      onClick: (rows) => actions.delete(rows),
      icon: "fa-trash-alt",
      perm: "blogs_page_delete_action",
    },
  ],
}
