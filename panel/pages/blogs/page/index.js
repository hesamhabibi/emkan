...
export default function Blogs() {
  ...
  const editModal = (item) => {
    ...
    setTitle(translation("Edit Page"))
  ...
  return (
    <AdminLayout
      action={
        <Shield id="blogs_page_create_action" action>
          <Button onClick={createModal} type="success">
            <i className="fas fa-plus-circle ml-1" />
            {translation("Add Page")}
          </Button>
        </Shield>
      }
    ...
    >
      ...
      />
      <Shield id="blogs_page_create_action" action>
        <AddBtn title={translation("Add Page")} callback={createModal} />
      </Shield>
      <Comment
