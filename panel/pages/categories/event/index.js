...
export default function Categories() {
  ...
  const createModal = () => {
    ...
    setTitle(translation("create event", "category"))
  ...
  const editModal = (item) => {
    ...
    setTitle(
      translation("edit event", "category") +
        " " +
        `"${item.title_panel ?? "-"}"`
    )
    dispatch(openModal("editForms"))
  ...
  return (
    <AdminLayout
      action={
        <Shield id="categories_event_create_action" action>
      ...
      title={`${translation("Categories")} - ${translation("Event")}`}
    >
