...
export default {
  ...
  tableFields: (translation) => [
    { title: "title_panel", perm: "categories_event_title_column" },
    {
      title: "status",
      td: (item) => translation(item.show_in_menu ? "Active" : "inactive"),
      perm: "categories_event_status_column",
    },
    {
      title: "show_in_menu",
      td: (item) =>
      ...
      perm: "categories_event_show_in_menu_column",
    },
  ],

  fields: (getValues, setValue, fireToast, translation) => [
    {
      perm: "categories_event_main_tab",
      ...
      form: [
        {
          ...
          type: "multi-language",
          component: "text",
          perm: "categories_event_title_field",
          gridSize: 6,
        },
        {
          perm: "categories_event_active_field",
          size: 6,
          name: "active",
          type: "toggle",
          section: "category",
        ...
        {
          size: 6,
          perm: "categories_event_show_in_menu_field",
          name: "show_in_menu",
          type: "toggle",
          section: "category",
          data: [
        ...
        {
          perm: "categories_event_image_field",
          type: "image",
          name: "media",
          size: 12,
        ...
        },
        {
          ...
          component: "textarea",
          gridSize: "12",
          perm: "categories_event_description_field",
        },
      ],
    },
    {
      perm: "categories_event_seo_tab",
  ...
  tableActions: (actions, translation) => [
    {
      ...
      dir: "right",
      perm: "categories_event_edit_action",
    },
    {
      ...
      dir: "right",
      perm: "categories_event_delete_action",
    },
  ],
}
