...
export default function Categories() {
  ...
  const createModal = () => {
    ...
    setTitle(translation("create project", "category"))
  ...
  const editModal = (item) => {
    ...
    setTitle(
      translation("edit project", "category") +
        " " +
        `"${item.title_panel ?? "-"}"`
    )
    dispatch(openModal("editForms"))
  ...
  return (
    <AdminLayout
      action={
        <Shield id="categories_project_create_action" action>
      ...
      title={`${translation("Categories")} - ${translation("Project")}`}
    >
