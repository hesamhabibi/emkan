...
export default {
  ...
  tableFields: (translation) => [
    { title: "title_panel", perm: "categories_catalogue_title_column" },
    {
      title: "status",
      td: (item) => translation(item.show_in_menu ? "Active" : "inactive"),
      perm: "categories_catalogue_status_column",
    },
    {
      title: "show_in_menu",
      td: (item) =>
      ...
      perm: "categories_catalogue_show_in_menu_column",
    },
  ],

  fields: (getValues, setValue, fireToast, translation) => [
    {
      perm: "categories_catalogue_main_tab",
      ...
      form: [
        {
          ...
          type: "multi-language",
          component: "text",
          perm: "categories_catalogue_title_field",
          gridSize: 6,
        },
        {
          perm: "categories_catalogue_active_field",
          size: 6,
          name: "active",
          type: "toggle",
          section: "category",
        ...
        {
          size: 6,
          perm: "categories_catalogue_show_in_menu_field",
          name: "show_in_menu",
          type: "toggle",
          section: "category",
          data: [
        ...
        {
          perm: "categories_catalogue_image_field",
          type: "image",
          name: "media",
          size: 12,
        ...
        },
        {
          ...
          component: "textarea",
          gridSize: "12",
          perm: "categories_catalogue_description_field",
        },
      ],
    },
    {
      perm: "categories_catalogue_seo_tab",
  ...
  tableActions: (actions, translation) => [
    {
      ...
      dir: "right",
      perm: "categories_catalogue_edit_action",
    },
    {
      ...
      dir: "right",
      perm: "categories_catalogue_delete_action",
    },
  ],
}
