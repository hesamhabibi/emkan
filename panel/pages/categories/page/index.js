...
import { array_pluck, flat_tree } from "~/app/Tree"
...
export default function Categories() {
  ...
  const createModal = () => {
    ...
    setTitle(translation("create page", "category"))
  ...
  const editModal = (item) => {
    ...
    setTitle(
      translation("edit page", "category") +
        " " +
        `"${item.title_panel ?? "-"}"`
    )
    dispatch(openModal("editForms"))
  ...
  return (
    <AdminLayout
      action={
        <Shield id="categories_page_create_action" action>
      ...
      title={`${translation("Categories")} - ${translation("Page")}`}
    >
