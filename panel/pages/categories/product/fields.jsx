...
export default {
  ...
  tableFields: (translation) => [
    { title: "title_panel", perm: "categories_product_title_column" },
    {
      title: "status",
      td: (item) => translation(item.show_in_menu ? "Active" : "inactive"),
      perm: "categories_product_status_column",
    },
    {
      title: "show_in_menu",
      td: (item) =>
      ...
      perm: "categories_product_show_in_menu_column",
    },
  ],

  fields: (getValues, setValue, fireToast, translation) => [
    {
      perm: "categories_product_main_tab",
      ...
      form: [
        {
          ...
          type: "multi-language",
          gridSize: 6,
          perm: "categories_product_title_field",
        },
        {
          perm: "categories_product_active_field",
          size: 6,
          name: "active",
          type: "toggle",
          section: "category",
        ...
        {
          perm: "categories_product_show_in_menu_field",
          size: 6,
          name: "show_in_menu",
          type: "toggle",
          section: "category",
        ...
        {
          perm: "categories_product_image_field",
          type: "image",
          name: "media",
          size: 12,
        ...
        },
        {
          ...
          type: "multi-language",
          perm: "categories_product_description_field",
        },
      ],
    },
    {
      perm: "categories_product_seo_tab",
