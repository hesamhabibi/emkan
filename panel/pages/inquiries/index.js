...
const statusTypes = [
  { name: "hide_prices", id: 0 },
  { name: "show_prices", id: 6 },
]
              ...
              <tr className={`${Styles.footer} ${Styles.noBorder}`}>
                <td colSpan={5} rowSpan={4}>
                  <span className="d-flex flex-column justify-content-center">
                    <p>
                      {translation("Inquiry Name")}: {(factor?.note || '').split('~')[0]}
                    </p>
                    <p>
                      {translation("Inquiry Mobile")}: {(factor?.note || '').split('~')[1]}
                    </p>
                    <p>
                      {translation("state")}: {(factor?.note || '').split('~')[2]}
                    </p>
                    <p>
                      {translation("note")}: {(factor?.note || '').split('~')[3]}
                    </p>
                  </span>
                </td>
