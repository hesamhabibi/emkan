...
export default function General({
  ...
  return (
    <Section>
      ...
      <Grid size={9}>
        <Input
          type="select-sorted-single"
          data={[{ title_web: '-بدون دسته بندی-', name: '-بدون دسته بندی-', id: null }, ... (data.categories || [])]}
      ...
      <Grid size={9}>
        <Input
          ...
          data={[{ title_web: '-بدون برند-', name: '-بدون برند-', id: null }, ... (data.brands || [])]}
