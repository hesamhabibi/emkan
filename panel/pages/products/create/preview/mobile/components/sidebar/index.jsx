...
const Sidebar = ({ section, setSection, control, callback, errors }) => {
      ...
      <div className={Styles.body}>
        <div className={Styles.container}>
          <div
            ...
            className={`${Styles.card} ${section === 1 ? Styles.active : ""} ${
              containsError(errors, statusFields) ? Styles.error : ""
            }`}
          >
          ...
          <div
            onClick={setSection.bind(this, 8)}
            className={`${Styles.card} ${section === 8 ? Styles.active : ""} ${
              containsError(errors, ["tutorials"]) ? Styles.error : ""
            }`}
          >
