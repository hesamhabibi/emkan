...
const TabComponents = [
    {
        Tab: General,
        permission: "products_service_main_tab",
        title: "product status",
        errors: statusFields,
    },
    {
        Tab: Seo,
        permission: "products_service_seo_tab",
        title: "seo and optimization",
        errors: ["seo"],
    },
    {
        Tab: Gallery,
        permission: "products_service_images_tab",
        title: "product images",
        errors: galleryFields,
    },
    {
        Tab: Attributes,
        permission: "products_service_table_tab",
        title: "product table",
        errors: ["attribute_groups"],
    },
    {
        Tab: Variants,
        permission: "products_service_price_tab",
        title: "product attributes",
        errors: variantFields,
    },
    {
        Tab: Extra,
        permission: "products_service_advanced_tab",
        title: "advanced",
        errors: extraFields,
    },
    {
        Tab: RelatedProducts,
        permission: "products_service_related_tab",
        title: "related products",
        errors: ["collections"],
    },
    {
        Tab: Tutorials,
        permission: "products_service_tutorial_tab",
        title: "Tutorial",
        errors: ["tutorials"],
    },
]
