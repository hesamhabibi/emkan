...
export default function Mobile({
  ...
  return (
    <>
      <div className={`${Styles.behind} ${focused ? Styles.bg : ""}`} />
      <label>{label}</label>
      <div ref={inputBox} className={Styles.container}>
        <span
          onClick={setFocused.bind(this, true)}
        ...
        <div className={`${Styles.dropDown} ${focused ? Styles.active : ""}`}>
          <div className={Styles.calendar}>
            <Tab id="calendar-manager">
              <div title={translation("Date")}>
                <div className={Styles.header}>
                  <h6 className="mr-3">{month.format("YYYY MMMM")}</h6>
                  <span className={Styles.action}>
                    <i
                      onClick={() => setMonth((prev) => prev.clone().add(1, "months"))}
                ...
                <div className={Styles.body}>
                  ...
                  <div>
                    ...
                    <span
                      onClick={(e) => {onChange(startOf.clone())}}
              ...
              <div title={translation("Hour")}>
                <GridContainer gap="Md" className={Styles.timeBody}>
                  <Grid size={12}>
                  ...
                  <Grid size="2" className={`mb-1 text-center ${Styles.timer}`}>
                    :
                  </Grid>
                  <Grid size="5">
                    <Input
                  ...
                  <Grid size={12}>
                    <DeviceView.Provider value={true}>
                      <Input
                        ...
                        data={[
                          {
                            name: translation("AM", "time_component"),
                            id: "AM",
                          },
                          {
                            name: translation("PM", "time_component"),
                            id: "PM",
                          },
                        ]}
                      />
